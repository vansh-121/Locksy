if (!document.getElementById("lockOverlay")) {
  ...
  overlay.innerHTML =
    ...
    '">' +
    '<p style="font-size: 20px; font-weight: bold; margin-bottom: 20px;">🔒 Enter Password to Unlock</p>' +
    '<input type="password" id="unlockPassword" placeholder="Password" style="' +
    'width: 100%; padding: 12px; border: 1px solid #777; border-radius: 6px;' +
    'font-size: 16px; outline: none; color: #ddd; background: #555;' +
    ...
    'transition: background 0.3s;">Unlock</button>' +
    '</div>';
